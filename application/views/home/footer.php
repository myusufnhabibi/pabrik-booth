<footer id="footer" class="border-0 mt-0">
            ...
            <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                ...
                <ul class="list list-unstyled">
                    ...
                    <li class="pb-1 mb-2">
                        ...
                        <a href="https://www.okler.net/cdn-cgi/l/email-protection#a0cdc1c9cce0c5d8c1cdd0ccc58ec3cfcd" class="text-decoration-none font-weight-light text-3-5 text-color-light text-color-hover-default"><span class="__cf_email__" data-cfemail="4f222e26230f2a372e223f232a612c2022">[email&#160;protected]</span></a>
                    </li>
                </ul>
    ...
    <div class="footer-copyright bg-light py-4">
        <div class="container py-2">
            <div class="row">
                <div class="col">
                    <p class="text-center text-3 mb-0">Porto Auto Services © 2024. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </div>
